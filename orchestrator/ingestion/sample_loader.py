...
def ingest_pdf(args: argparse.Namespace, pdf_path: Path, memory_manager: MemoryManager) -> None:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--doc-type", help="Document type (standard, manual, etc.)")
